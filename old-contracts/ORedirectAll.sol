...
contract RedirectAll is SuperAppBase {
    ...
    // function setTradeableflow(address tcfAddress) public {
    //   require(msg.sender == _ap.owner, "Only owner");
    //   // TODO: Require _tcf not set
    //   _tcf = ITradeableflow(tdfAddress);
    // }
    ...
    // TODO: manage if flow is started without affiliate
        ...
        returns (bytes memory newCtx)
    {
      ...
      // Get flow from app to affiliate
